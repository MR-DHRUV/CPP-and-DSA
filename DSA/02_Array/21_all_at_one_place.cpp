...
int main()
{
    ...
    cout << "Bin Search results" << endl;
    cout << arr.binarySearch(0) << endl;
    cout << arr.binarySearch(1) << endl;
    cout << arr.binarySearch(2) << endl;
    cout << arr.binarySearch(3) << endl;

    // cout << "Search results" << endl;
    // cout << arr.linearSearch(0) << endl;
    // cout << arr.linearSearch(1) << endl;
    ...
    cout << "elment at index 2 :  " << arr.Get(2) << endl;
    ...
    cout << "Is sorted :  " << (bool)arr.isSorted() << endl;
