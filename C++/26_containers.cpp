...
// Associative -> direct access eg : map, multimap, dictionary, set, multiset. all operations fasr except random access

// Derived -> can be derived from sequence or associative containers. used for real world modeling. 
